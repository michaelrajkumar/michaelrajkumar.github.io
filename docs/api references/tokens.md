...
<div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem' }}>
  ...
  <div className="code" style={{ flex: 2 }}>
    <div className="code-container">
      <div className="code-header">tokensIdGet</div>
...
<div className="code-block curl active" id="tokensIdGet-code-curl">
```js
curl -X GET\
...
<div className="code-block java" id="tokensIdGet-code-java">
```js
...
<div className="code-block android" id="tokensIdGet-code-android">
```js
import io.swagger.client.api.TokensApi;
...
<div className="code-block objc" id="tokensIdGet-code-objc">
```js
...
<div className="code-block javascript" id="tokensIdGet-code-javascript">
```js
...
<div className="code-block csharp" id="tokensIdGet-code-csharp">
```js
using System;
...
<div className="code-block php" id="tokensIdGet-code-php">
```js
<?php
...
<div className="code-block perl" id="tokensIdGet-code-perl">
```js
use Data::Dumper;
...
<div className="code-block python" id="tokensIdGet-code-python">
```js
...
<div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem' }}>
  ...
  <div className="code" style={{ flex: 2 }}>
    <div className="code-container">
      <div className="code-header">tokensPost</div>
      <div className="code-dropdown">
        <select onChange={(e) => handleLanguageChange(e.target)}>
          <option value="curl">curl</option><option value="java">java</option><option value="android">android</option><option value="objc">objc</option><option value="javascript">javascript</option><option value="csharp">csharp</option><option value="php">php</option><option value="perl">perl</option><option value="python">python</option>
        </select>
...
<div className="code-block curl active" id="tokensPost-code-curl">
```js
curl -X POST\
-H "Accept: application/json"\
...
<div className="code-block java" id="tokensPost-code-java">
```js
import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
...
<div className="code-block android" id="tokensPost-code-android">
```js
import io.swagger.client.api.TokensApi;
...
<div className="code-block objc" id="tokensPost-code-objc">
```js
...
<div className="code-block javascript" id="tokensPost-code-javascript">
```js
var OmiseApi = require('omise_api');
...
<div className="code-block csharp" id="tokensPost-code-csharp">
```js
using System;
using System.Diagnostics;
using IO.Swagger.Api;
...
<div className="code-block php" id="tokensPost-code-php">
```js
<?php
require_once(__DIR__ . '/vendor/autoload.php');
...
<div className="code-block perl" id="tokensPost-code-perl">
```js
use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TokensApi;
...
<div className="code-block python" id="tokensPost-code-python">
```js
from __future__ import print_statement
import time
import swagger_client
