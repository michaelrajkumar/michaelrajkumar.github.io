...
<div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem' }}>
  ...
  <div className="code" style={{ flex: 2 }}>
    <div className="code-container">
      <div className="code-header">eventsGet</div>
...
<div className="code-block curl active" id="eventsGet-code-curl">
```js
curl -X GET\
...
<div className="code-block java" id="eventsGet-code-java">
```js
...
<div className="code-block android" id="eventsGet-code-android">
```js
import io.swagger.client.api.EventsApi;
...
<div className="code-block objc" id="eventsGet-code-objc">
```js
...
<div className="code-block javascript" id="eventsGet-code-javascript">
```js
...
<div className="code-block csharp" id="eventsGet-code-csharp">
```js
using System;
...
<div className="code-block php" id="eventsGet-code-php">
```js
<?php
...
<div className="code-block perl" id="eventsGet-code-perl">
```js
use Data::Dumper;
...
<div className="code-block python" id="eventsGet-code-python">
```js
...
<div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem' }}>
  ...
  <div className="code" style={{ flex: 2 }}>
    <div className="code-container">
      <div className="code-header">eventsIdGet</div>
      <div className="code-dropdown">
        <select onChange={(e) => handleLanguageChange(e.target)}>
          <option value="curl">curl</option><option value="java">java</option><option value="android">android</option><option value="objc">objc</option><option value="javascript">javascript</option><option value="csharp">csharp</option><option value="php">php</option><option value="perl">perl</option><option value="python">python</option>
        </select>
...
<div className="code-block curl active" id="eventsIdGet-code-curl">
```js
curl -X GET\
-H "Accept: application/json"\
...
<div className="code-block java" id="eventsIdGet-code-java">
```js
import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
...
<div className="code-block android" id="eventsIdGet-code-android">
```js
import io.swagger.client.api.EventsApi;
...
<div className="code-block objc" id="eventsIdGet-code-objc">
```js
...
<div className="code-block javascript" id="eventsIdGet-code-javascript">
```js
var OmiseApi = require('omise_api');
...
<div className="code-block csharp" id="eventsIdGet-code-csharp">
```js
using System;
using System.Diagnostics;
using IO.Swagger.Api;
...
<div className="code-block php" id="eventsIdGet-code-php">
```js
<?php
require_once(__DIR__ . '/vendor/autoload.php');
...
<div className="code-block perl" id="eventsIdGet-code-perl">
```js
use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::EventsApi;
...
<div className="code-block python" id="eventsIdGet-code-python">
```js
from __future__ import print_statement
import time
import swagger_client
