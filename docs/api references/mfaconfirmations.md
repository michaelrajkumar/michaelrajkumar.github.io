...
<div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem' }}>
  ...
  <div className="code" style={{ flex: 2 }}>
    <div className="code-container">
      <div className="code-header">mfaConfirmationsPost</div>
...
<div className="code-block curl active" id="mfaConfirmationsPost-code-curl">
```js
curl -X POST\
...
<div className="code-block java" id="mfaConfirmationsPost-code-java">
```js
...
<div className="code-block android" id="mfaConfirmationsPost-code-android">
```js
import io.swagger.client.api.MfaConfirmationsApi;
...
<div className="code-block objc" id="mfaConfirmationsPost-code-objc">
```js
...
<div className="code-block javascript" id="mfaConfirmationsPost-code-javascript">
```js
...
<div className="code-block csharp" id="mfaConfirmationsPost-code-csharp">
```js
using System;
...
<div className="code-block php" id="mfaConfirmationsPost-code-php">
```js
<?php
...
<div className="code-block perl" id="mfaConfirmationsPost-code-perl">
```js
use Data::Dumper;
...
<div className="code-block python" id="mfaConfirmationsPost-code-python">
```js
