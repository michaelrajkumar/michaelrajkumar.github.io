...
<div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem' }}>
  ...
  <div className="code" style={{ flex: 2 }}>
    <div className="code-container">
      <div className="code-header">sourcesIdGet</div>
...
<div className="code-block curl active" id="sourcesIdGet-code-curl">
```js
curl -X GET\
...
<div className="code-block java" id="sourcesIdGet-code-java">
```js
...
<div className="code-block android" id="sourcesIdGet-code-android">
```js
import io.swagger.client.api.SourcesApi;
...
<div className="code-block objc" id="sourcesIdGet-code-objc">
```js
...
<div className="code-block javascript" id="sourcesIdGet-code-javascript">
```js
...
<div className="code-block csharp" id="sourcesIdGet-code-csharp">
```js
using System;
...
<div className="code-block php" id="sourcesIdGet-code-php">
```js
<?php
...
<div className="code-block perl" id="sourcesIdGet-code-perl">
```js
use Data::Dumper;
...
<div className="code-block python" id="sourcesIdGet-code-python">
```js
...
<div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem' }}>
  ...
  <div className="code" style={{ flex: 2 }}>
    <div className="code-container">
      <div className="code-header">sourcesPost</div>
      <div className="code-dropdown">
        <select onChange={(e) => handleLanguageChange(e.target)}>
          <option value="curl">curl</option><option value="java">java</option><option value="android">android</option><option value="objc">objc</option><option value="javascript">javascript</option><option value="csharp">csharp</option><option value="php">php</option><option value="perl">perl</option><option value="python">python</option>
        </select>
...
<div className="code-block curl active" id="sourcesPost-code-curl">
```js
curl -X POST\
-H "Accept: application/json"\
...
<div className="code-block java" id="sourcesPost-code-java">
```js
import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
...
<div className="code-block android" id="sourcesPost-code-android">
```js
import io.swagger.client.api.SourcesApi;
...
<div className="code-block objc" id="sourcesPost-code-objc">
```js
...
<div className="code-block javascript" id="sourcesPost-code-javascript">
```js
var OmiseApi = require('omise_api');
...
<div className="code-block csharp" id="sourcesPost-code-csharp">
```js
using System;
using System.Diagnostics;
using IO.Swagger.Api;
...
<div className="code-block php" id="sourcesPost-code-php">
```js
<?php
require_once(__DIR__ . '/vendor/autoload.php');
...
<div className="code-block perl" id="sourcesPost-code-perl">
```js
use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::SourcesApi;
...
<div className="code-block python" id="sourcesPost-code-python">
```js
from __future__ import print_statement
import time
import swagger_client
